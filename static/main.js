...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _chatUsersList__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chatUsersList */ \"./assets/js/chatUsersList.js\");\nvar _require = __webpack_require__(/*! ./socket */ \"./assets/js/socket.js\"),\n    getSocket = _require.getSocket;\n\n\nvar chatRoom = document.querySelector(\".chatRoom\");\nvar chatInputForm = document.querySelector(\".chatFormWrapper\");\nvar formContainer = document.querySelector(\".chatFriendsForm\");\nvar chatAddForm = document.querySelector(\".chatFriends__form\");\nvar chatAddInput = chatAddForm ? chatAddForm.querySelector(\"input\") : \"\";\nvar chatAddUl = document.querySelector(\".plusFriends\");\nvar searchFriend = document.querySelector(\".chatFriendsPlus\");\nvar closeBtn = document.querySelector(\".closeBtn\");\nvar location = window.location.href.split(\"chat/\")[1];\nvar socket = getSocket();\nvar Friend = null;\n\nvar foundFriend = function foundFriend(findValue, isPeople) {\n  if (findValue.length !== 0 && !isPeople) {\n    Friend = findValue;\n    chatAddUl.innerText = \"\";\n    var li = document.createElement(\"li\");\n    li.innerHTML = findValue[0].avatarUrl ? \"<div class=\\\"chatAddFriend\\\">\\n            <img src=\".concat(findValue[0].avatarUrl, \" />\\n            <div class=\\\"chatAddName\\\"/>\").concat(findValue[0].name, \"</div>\\n        </div> \\n        <i class=\\\"fas fa-plus-circle chatAddBtn\\\"></i>\\n        \") : \"<div class=\\\"chatAddFriend\\\"> <div class=\\\"icon\\\"><i class=\\\"fas fa-user-alt\\\"></i></div>\\n        <div class=\\\"chatAddName\\\"/>\".concat(findValue[0].name, \"</div> </div>\\n        <i class=\\\"fas fa-plus-circle chatAddBtn\\\"></i>\\n        \");\n    chatAddUl.appendChild(li);\n    var chatAddBtn = li.querySelector(\".chatAddBtn\");\n    chatAddBtn.addEventListener(\"click\", handleInvite);\n  } else if (findValue.length === 0) {\n    chatAddUl.innerText = \"Can't Find\";\n  } else if (isPeople) {\n    chatAddUl.innerText = \"The User is already in this Chat Room\";\n  }\n};\n\nvar plusAlarm = function plusAlarm(message, Friend) {\n  var alarmLi = document.createElement(\"li\");\n  alarmLi.className = \"messageAlarm\";\n  alarmLi.innerText = message;\n  var Ul = chatRoom.querySelector(\"ul\");\n  Ul.appendChild(alarmLi);\n  Object(_chatUsersList__WEBPACK_IMPORTED_MODULE_0__[\"addUsers\"])(Friend[0].avatarUrl, Friend[0].name);\n}; // 채팅창에 플러스 버튼을 눌렀을때 이벤트\n\n\nvar chatAddSocket = function chatAddSocket(findValue) {\n  socket.emit(\"chatFindFriend\", {\n    findValue: findValue,\n    location: location\n  });\n  socket.on(\"findFriend\", function (_ref) {\n    var findFriend = _ref.findFriend,\n        isPeople = _ref.isPeople;\n    return foundFriend(findFriend, isPeople);\n  });\n}; // 친구 초대창에서 친구 플러스 버튼을 눌렀을 때\n\n\nvar handleInvite = function handleInvite(e) {\n  e.target.style.display = \"none\";\n  socket.emit(\"chatPlusFriend\", {\n    Friend: Friend,\n    location: location\n  });\n}; // 찾을 이메일을 검색했을 때\n\n\nvar handleChatAdd = function handleChatAdd(e) {\n  e.preventDefault();\n  if (chatAddUl.firstChild) chatAddUl.removeChild(chatAddUl.firstChild);\n  var findValue = chatAddInput.value;\n  chatAddInput.value = \"\";\n  chatAddSocket(findValue);\n};\n\nvar handleAddClick = function handleAddClick() {\n  formContainer.style.display = \"block\";\n  formContainer.classList.remove(\"modalCloseAnimation\");\n  formContainer.classList.add(\"modalAnimation\");\n  chatAddInput.classList.remove(\"inputCloseModal\");\n  chatAddInput.classList.add(\"inputModal\");\n  chatRoom.style.opacity = \"0.1\";\n  chatInputForm.style.opacity = \"0.1\";\n};\n\nvar handleCloseClick = function handleCloseClick() {\n  formContainer.classList.remove(\"modalAnimation\");\n  formContainer.classList.add(\"modalCloseAnimation\");\n  chatAddInput.classList.remove(\"inputModal\");\n  chatAddInput.classList.add(\"inputCloseModal\");\n  chatRoom.style.opacity = \"1\";\n  chatInputForm.style.opacity = \"1\";\n  if (chatAddUl.firstElementChilds) chatAddUl.removeChild(chatAddUl.firstElementChild);\n  chatAddUl.innerText = \"\";\n};\n\nvar init = function init() {\n  if (chatAddForm) {\n    chatAddForm.addEventListener(\"submit\", handleChatAdd);\n    socket.on(\"chatPlusFriendAlarm\", function (_ref2) {\n      var message = _ref2.message,\n          Friend = _ref2.Friend;\n      return plusAlarm(message, Friend);\n    });\n  }\n\n  if (searchFriend) searchFriend.addEventListener(\"click\", handleAddClick);\n  if (closeBtn) closeBtn.addEventListener(\"click\", handleCloseClick);\n};\n\ninit();\n\n//# sourceURL=webpack:///./assets/js/chatAddFriend.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"receiveChat\", function() { return receiveChat; });\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _enterRoom__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./enterRoom */ \"./assets/js/enterRoom.js\");\n/* harmony import */ var _enterRoom__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_enterRoom__WEBPACK_IMPORTED_MODULE_1__);\n\n\n\nvar _require = __webpack_require__(/*! ./socket */ \"./assets/js/socket.js\"),\n    initSockets = _require.initSockets,\n    getSocket = _require.getSocket;\n\nvar chatForm = document.querySelector(\".chatForm\");\nvar chatRoom = document.querySelector(\".chatRoom\");\nvar chatInput = document.querySelector(\".input\");\nvar comments = document.querySelector(\".comments\");\nvar roomID = chatForm ? window.location.href.split(\"chat/\")[1].split(\"?\")[0] : \"\";\nvar socket = null;\n\nvar addChatMessage = function addChatMessage(message, name, avatarUrl) {\n  var li = document.createElement(\"li\");\n\n  if (name !== undefined) {\n    li.className = \"InputNotMyMessage\";\n    li.innerHTML = avatarUrl ? \"<div class=\\\"NotMymessageProfile\\\"> <img src=\".concat(avatarUrl, \"></img> <div class=\\\"messageName\\\">\").concat(name, \"</div></div>\\n    <div class=\\\"messageContent\\\">\").concat(message, \"</div>\") : \"<div class=\\\"NotMymessageProfile\\\">  <div class=\\\"iconWrapper\\\"><i class=\\\"fas fa-user-alt\\\"></i></div><div class=\\\"messageName\\\">\".concat(name, \"</div></div>\\n      <div class=\\\"messageContent\\\">\").concat(message, \"</div>\");\n  } else {\n    //내 매세지일 경우\n    li.className = \"InputMyMessage\";\n    li.innerHTML = \"<div class=\\\"Mymessage__content\\\">\".concat(message, \"</div>\");\n  }\n\n  comments.appendChild(li);\n  chatRoom.scrollTop = chatRoom.scrollHeight;\n};\n\nvar socketMessage = function socketMessage(message) {\n  var userId = window.location.href.split(\"/chat\")[0].split(\"user/\")[1];\n  socket.emit(\"sendMessage\", {\n    roomID: roomID,\n    message: message,\n    userId: userId\n  });\n};\n\nvar receiveChat = function receiveChat(_ref) {\n  var message = _ref.message,\n      name = _ref.name,\n      avatarUrl = _ref.avatarUrl;\n  addChatMessage(message, name, avatarUrl);\n};\n\nvar handleChat = function handleChat(event) {\n  event.preventDefault();\n  var message = chatInput.value;\n\n  if (message !== \"\") {\n    socketMessage(message);\n    addChatMessage(message);\n    chatInput.value = \"\";\n  }\n};\n\nvar init = function init() {\n  if (chatForm) {\n    socket = io(\"/\");\n    initSockets(socket);\n    socket.emit(\"socketJoin\");\n    chatRoom.scrollTop = chatRoom.scrollHeight;\n    chatForm.addEventListener(\"submit\", handleChat);\n    socket.on(\"receiveMessage\", receiveChat);\n  }\n};\n\ninit();\n\n//# sourceURL=webpack:///./assets/js/chatScreen.js?");

/***/ }),

/***/ "./assets/js/chatUsersList.js":
/*!************************************!*\
  !*** ./assets/js/chatUsersList.js ***!
  \************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"addUsers\", function() { return addUsers; });\nvar _require = __webpack_require__(/*! ./socket */ \"./assets/js/socket.js\"),\n    getSocket = _require.getSocket;\n\nvar FriendInviteBtn = document.querySelector(\".chatFriendsPlus\");\nvar chatUsers = document.querySelector(\".chatUsers__users\");\nvar closeBtn = document.querySelector(\".closeBtn\");\nvar socket = getSocket();\nvar addUsers = function addUsers(avatarUrl, name) {\n  var li = document.createElement(\"li\");\n  li.innerHTML = avatarUrl ? \"<div class=\\\"chatAddFriend\\\">\\n  <img src=\".concat(avatarUrl, \" />\\n  <div class=\\\"chatAddName\\\"/>\").concat(name, \"</div>\\n</div> \\n\") : \"<div class=\\\"chatAddFriend\\\"> <div class=\\\"icon\\\"><i class=\\\"fas fa-user-alt\\\"></i></div>\\n<div class=\\\"chatAddName\\\"/>\".concat(name, \"</div> </div>\\n\");\n  chatUsers.appendChild(li);\n};\n\nvar handleFindList = function handleFindList(e) {\n  chatUsers.innerHTML = \"\";\n  var location = window.location.href.split(\"chat/\")[1];\n  socket = getSocket();\n  socket.emit(\"findList\", {\n    location: location\n  });\n};\n\nvar init = function init() {\n  if (FriendInviteBtn) {\n    FriendInviteBtn.addEventListener(\"click\", handleFindList);\n    socket.on(\"foundList\", function (_ref) {\n      var peoples = _ref.peoples;\n      peoples.forEach(function (people) {\n        return addUsers(people.avatarUrl, people.name);\n      });\n    });\n  }\n};\n\ninit();\n\n//# sourceURL=webpack:///./assets/js/chatUsersList.js?");

/***/ }),

/***/ "./assets/js/enterRoom.js":
/*!********************************!*\
  !*** ./assets/js/enterRoom.js ***!
  \********************************/
...
eval("var _require = __webpack_require__(/*! ./socket */ \"./assets/js/socket.js\"),\n    initSockets = _require.initSockets;\n\nvar roomContainer = document.querySelectorAll(\".roomsOutWrapper\");\n\nvar handleRoomEnter = function handleRoomEnter(e) {\n  var roomId = e.target.href.split(\"chat/\")[1];\n  console.log(\"\\uC785\\uC7A5 \".concat(roomId));\n  var enterSocket = io(\"/\");\n  initSockets(enterSocket);\n  enterSocket.on(\"connect\", function () {\n    enterSocket.emit(\"enterRoom\", {\n      roomId: roomId\n    });\n  });\n};\n\nvar init = function init() {\n  roomContainer.forEach(function (room) {\n    return room.addEventListener(\"click\", handleRoomEnter);\n  });\n};\n\ninit();\n\n//# sourceURL=webpack:///./assets/js/enterRoom.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _scss_styles_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../scss/styles.scss */ \"./assets/scss/styles.scss\");\n/* harmony import */ var _scss_styles_scss__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_scss_styles_scss__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _addFriend__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./addFriend */ \"./assets/js/addFriend.js\");\n/* harmony import */ var _sendMessage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./sendMessage */ \"./assets/js/sendMessage.js\");\n/* harmony import */ var _chatScreen__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./chatScreen */ \"./assets/js/chatScreen.js\");\n/* harmony import */ var _enterRoom__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./enterRoom */ \"./assets/js/enterRoom.js\");\n/* harmony import */ var _enterRoom__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_enterRoom__WEBPACK_IMPORTED_MODULE_4__);\n/* harmony import */ var _roomLatestMessage__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./roomLatestMessage */ \"./assets/js/roomLatestMessage.js\");\n/* harmony import */ var _roomLatestMessage__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_roomLatestMessage__WEBPACK_IMPORTED_MODULE_5__);\n/* harmony import */ var _chatAddFriend__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./chatAddFriend */ \"./assets/js/chatAddFriend.js\");\n/* harmony import */ var _chatUsersList__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./chatUsersList */ \"./assets/js/chatUsersList.js\");\n/* harmony import */ var _roomsDesignChange__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./roomsDesignChange */ \"./assets/js/roomsDesignChange.js\");\n/* harmony import */ var _roomsDesignChange__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_roomsDesignChange__WEBPACK_IMPORTED_MODULE_8__);\n/* harmony import */ var _makeRoom__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./makeRoom */ \"./assets/js/makeRoom.js\");\n/* harmony import */ var _makeRoom__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_makeRoom__WEBPACK_IMPORTED_MODULE_9__);\n\n\n\n\n\n\n\n\n\n //footer 설정\n\nvar footer = document.querySelector(\".footer__nav\");\nvar ul = footer ? footer.querySelector(\"ul\") : \"\";\nvar li = ul ? ul.querySelectorAll(\"li\") : \"\";\nvar nowUrl = window.location.href;\n\nvar init = function init() {\n  li.forEach(function (item) {\n    var a = item.querySelector(\"a\");\n    var icon = a.querySelector(\"i\");\n    if (nowUrl === a.href) icon.style.color = \"black\";\n  });\n};\n\ninit();\n\n//# sourceURL=webpack:///./assets/js/main.js?");

/***/ }),

/***/ "./assets/js/makeRoom.js":
/*!*******************************!*\
  !*** ./assets/js/makeRoom.js ***!
  \*******************************/
/*! no static exports found */
...
eval("var makeRoomBtn = document.querySelector(\".makeRoomBtn\");\n\n//# sourceURL=webpack:///./assets/js/makeRoom.js?");

/***/ }),

/***/ "./assets/js/roomLatestMessage.js":
/*!****************************************!*\
  !*** ./assets/js/roomLatestMessage.js ***!
  \****************************************/
/*! no static exports found */
...
eval("var roomContainer = document.querySelectorAll(\".roomsOutWrapper\");\n\nvar init = function init() {\n  var socket = io(\"/\");\n  socket.on(\"showMessage\", function (_ref) {\n    var showMessage = _ref.showMessage,\n        roomSocket = _ref.roomSocket;\n    roomContainer.forEach(function (room) {\n      room.style.order = \"0\";\n\n      if (room.href.split(\"chat/\")[1] === roomSocket) {\n        var span = room.querySelector(\".showMessage\");\n\n        if (span === null) {\n          span = room.querySelector(\".roomImages\").querySelector(\".showMessage\");\n        }\n\n        var fixedMessage = showMessage.length > 15 ? showMessage.slice(0, 14) + \".....\" : showMessage;\n        room.style.order = \"-1\";\n        room.classList.add(\"acceptMessage\");\n        span.innerHTML = fixedMessage;\n        setTimeout(function () {\n          return room.classList.remove(\"acceptMessage\");\n        }, 1000);\n      }\n    });\n  });\n};\n\ninit();\n\n//# sourceURL=webpack:///./assets/js/roomLatestMessage.js?");

/***/ }),

/***/ "./assets/js/roomsDesignChange.js":
/*!****************************************!*\
  !*** ./assets/js/roomsDesignChange.js ***!
  \****************************************/
/*! no static exports found */
...
/*!**********************************!*\
  !*** ./assets/js/sendMessage.js ***!
  \**********************************/
/*! exports provided: handleSendBtn */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"handleSendBtn\", function() { return handleSendBtn; });\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _socket__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./socket */ \"./assets/js/socket.js\");\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n\n\nvar sendBtn = document.querySelector(\".sendBtn\");\nvar handleSendBtn = function handleSendBtn(_ref) {\n  var id = _ref.id,\n      userId = _ref.userId;\n  window.location.href = \"/user/\".concat(userId, \"/chat/\").concat(id);\n};\n\nvar sendClick = /*#__PURE__*/function () {\n  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n    var sendId, response, socket;\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            sendId = window.location.href.split(\"user/\")[1].split(\"/profile\")[0];\n            _context.next = 3;\n            return axios__WEBPACK_IMPORTED_MODULE_0___default()({\n              url: \"/api/makeRoom\",\n              method: \"POST\",\n              data: {\n                sendId: sendId\n              }\n            });\n\n          case 3:\n            response = _context.sent;\n\n            if (response.status === 200) {\n              socket = io(\"/\");\n              socket.on(\"connect\", function () {\n                socket.emit(\"sendBtn\", {\n                  sendId: sendId\n                });\n                Object(_socket__WEBPACK_IMPORTED_MODULE_1__[\"initSockets\"])(socket);\n              });\n            }\n\n          case 5:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee);\n  }));\n\n  return function sendClick() {\n    return _ref2.apply(this, arguments);\n  };\n}();\n\nvar init = function init() {\n  if (sendBtn) sendBtn.addEventListener(\"click\", sendClick);\n};\n\ninit();\n\n//# sourceURL=webpack:///./assets/js/sendMessage.js?");
